...
const SPEC_IDS_WITH_APL = [
  62, 63, 64, // Mage
  66, 70, // Paladin (no Holy)
  71, 72, 73, // Warrior
  102, 103, 104, 105, // Druid (Resto has a DPS APL upstream)
  250, 251, 252, // Death Knight
  253, 254, 255, // Hunter
  258, // Priest (Shadow only)
  259, 260, 261, // Rogue
  262, 263, // Shaman (no Resto)
  265, 266, 267, // Warlock
  268, 269, // Monk (no Mistweaver)
  577, 581, 1480, // Demon Hunter (incl. Midnight's Devourer)
  1467, 1473, // Evoker (no Preservation)
]
