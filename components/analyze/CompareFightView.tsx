                            ...
                            {[
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <span style={{ fontSize: 13, fontWeight: 400, color: 'var(--dim)' }}>
                                            dps
                                        </span>
                                    </div>
                                    <div
                            ...
                            <>
                                ...
                                >
                                    ...
                                    {messagesCompare.map((m, i) => {
                                        const isLastUser =
                                            m.role === 'user' &&
                                            messagesCompare.slice(i + 1).every((x) => x.role !== 'user')
                                        return (
                                            <div
                                                key={i}
                                                ref={isLastUser ? lastUserMsgRef : null}
                                                style={{ marginBottom: m.role === 'user' ? 8 : 12 }}
                                            >
                                                {m.role === 'user' ? (
                                                    <div
                                                        style={{
                                                            ...
                                                            <div style={{ position: 'relative' }}>
                                                                ...
                                                                >
                                                                    {showTyping ? (
                                                                        ...
                                                                        >
                                                                            ...
                                                                            >
                                                                                Analyzing…{' '}
                                                                                {aiLiveStatus
                                                                                    ? `${aiLiveStatus.elapsedSec}s`
                                                                                    : '0s'}
                                                                                {aiLiveStatus?.inputTokens !=
                                                                                null
                                                                                    ? ` · ${aiLiveStatus.inputTokens.toLocaleString()} in`
                                                                                    : ''}
                                                                                {aiLiveStatus?.outputTokens !=
                                                                                null
                                                                    ...
                                                                    {m.usage && !streamingHere ? (
                                                                        ...
                                                                        >
                                                                            {m.usage.in.toLocaleString()}{' '}
                                                                            tokens in ·{' '}
                                                                            {m.usage.out.toLocaleString()} out
                                                                        </div>
                                                                    ) : null}
                                                                </div>
                                            ...
                                            >
                                                ...
                                                <div style={{ display: 'flex', flexWrap: 'wrap', gap: 5 }}>
                                                    ...
                                                    <button
                                                        ...
                                                        className={pa.guideChip}
                                                        onClick={() =>
                                                            sendCompareQuestion(PRESET_COMPARE_ROTATION_ICY)
                                                        }
                                                    >
                                                        Icy Veins
                                                    </button>
                                                    <button
                                                        ...
                                                        className={pa.guideChip}
                                                        onClick={() =>
                                                            sendCompareQuestion(PRESET_COMPARE_ROTATION_BOTH)
                                                        }
                                                    >
                                                        Both
                                                    </button>
