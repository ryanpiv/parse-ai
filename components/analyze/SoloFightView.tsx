                                ...
                                >
                                    <div style={{ minWidth: 140, flex: '1 1 160px' }}>
                                        ...
                                        >
                                            ...
                                            <span
                                                style={{ fontSize: 13, fontWeight: 400, color: 'var(--dim)' }}
                                            >
                                                dps
                                            </span>
                                        </div>
                                    ...
                                    <>
                                        ...
                                        >
                                            {messagesAnalyze.length === 0 && !aiLoading && (
                                                ...
                                                >
                                                    No messages yet — try a quick question below or type your
                                                    own.
                                                </div>
                                            )}
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        {m.role === 'user' ? (
                                                            ...
                                                            (() => {
                                                                const isLast =
                                                                    i === messagesAnalyze.length - 1
                                                                const streamingHere = isLast && aiLoading
                                                                const showTyping =
                                                                    streamingHere && !m.content.trim()
                                                                const bubblePad =
