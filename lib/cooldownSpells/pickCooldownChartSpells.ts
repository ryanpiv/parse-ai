...
const EXCLUDED_BUFF_SPELL_IDS = new Set<number>([1459, 27348, 21562, 1126, 21849, 6673, 264735, 264760, 1044])
...
function getCdMs(
    map: Record<string, number | null | undefined> | null,
    id: number,
...
export function sortCooldownRows(
    ...
    return [...rows].sort((a, b) => {
        ...
        return estimatedCooldownSec(b, dur1, dur2) - estimatedCooldownSec(a, dur1, dur2)
    })
}
