 ...
 */
export function computeUptimes(
    buffWindows: Record<number, Array<{ start: number; end: number }>>,
    dur: number,
 ...
 */
export function computeCastSpacing(
    annotatedCasts: any[],
): Record<number, { avgGap: number; minGap: number; maxGap: number }> {
