...
export const COMPARE_TOP_QUICK_ITEMS: CompareQuickTopItem[] = [
    {
        ...
        title: 'Sends the full default compare prompt (you vs other player, Part 1 + Part 2, wipes). Uses log + talent context only — not SimulationCraft APL unless you use the “Ask: both players vs SimC APL” or rotation-guide presets.',
    },
    {
        kind: 'preset',
        label: PRESET_COMPARE_TALENT_LOG_LABEL,
        prompt: PRESET_COMPARE_TALENT_LOG,
        title: 'Asks Claude to contrast both players’ talent picks using the diff in context, tied to this fight’s log (casts, cooldowns, procs). Does not add SimC, Wowhead, or Icy Veins.',
    },
]
